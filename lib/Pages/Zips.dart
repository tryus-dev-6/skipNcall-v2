...
class _ZipState extends State<Zip> with AutomaticKeepAliveClientMixin<Zip> {
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.extended(
          heroTag: UniqueKey(),
          onPressed: () {
            Get.toNamed("/purchaseZip");
          },
          backgroundColor: const Color(0xfffff4f1),
          icon: const Icon(Icons.add, color: Color(0Xff452b2e)),
          label: const Text("Purchase Zip",
              style: TextStyle(color: Color(0Xff452b2e))),
        ),
      ),
    );
  }
  ...
  Future<void> loadData() async {
    ...
    var cartBody = {"client_id": userId, "page": "1"};
